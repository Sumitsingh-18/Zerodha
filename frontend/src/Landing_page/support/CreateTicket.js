        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''>
                       <i class="fa-duotone fa-solid fa-user-circle fa-sm"></i>Your Zerodha Account
                    </h4>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''>
                     <i class="fa-sharp fa-solid fa-indian-rupee"></i>Funds
                    </h4>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Portfollio</a>
                    <br/>
